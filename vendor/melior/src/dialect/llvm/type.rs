...
/// Creates an LLVM opaque pointer type.
///
/// NOTE: MLIR 18 changed `mlirLLVMPointerTypeGet` to take a `MlirContext`
/// (not `MlirType`). melior 0.14 was written for the MLIR 17 signature;
/// patched here to match MLIR 18.
